...
var encabezadoApp = '\n ________________________________________________\n|' +
    '\n|\t      VENTA DE PELICULAS                 |' +
    '\n|________________________________________________|\n\n';
var menuPrincipal = encabezadoApp +
    '\t(1)Adminstrador\n' +
    '\t(2)Cliente\n' +
    '\t(3)Salir\n' +
    '\n ________________________________________________\n';
var menuAdministrador = encabezadoApp +
    '\t(1)Registrar Peliculas\n' +
    '\t(2)Eliminar Pelicula\n' +
    '\t(3)Actualizar Pelicula\n' +
    '\t(4)Salir\n' +
    '\n ________________________________________________\n';
var menuCliente = encabezadoApp +
    '\t(1)Mostrar Peliculas\n' +
    '\t(2)Comprar Pelicula\n' +
    '\t(3)Salir\n' +
    '\n ________________________________________________\n';
var mensajeSalir = encabezadoApp + '\n\n\n\tFIN DE LA APLICACION';
var administrador = {
    userId: 1,
    userName: 'jonathan',
    password: '12345'
...
rl.question(menuPrincipal + 'Seleccione una opcion: ', function (respuesta) {
    console.clear();
...
function seleccionarOpcionAdministrador() {
    ...
    rl.question(menuAdministrador + 'Seleccione una opcion: ', function (respuesta) {
        switch (respuesta.toString().trim()) {
            case '1':
                registrarPelicula();
                break;
...
function seleccionarOpcionCliente() {
    console.clear();
    //let continuarCiclo = true;
    rl.question(menuCliente + 'Seleccione una opcion: ', function (respuesta) {
        switch (respuesta.toString().trim()) {
            case '1':
                mostrarPelicula();
                break;
...
function registrarPelicula() {
    ...
    console.log('|________________________________________________|\n');
    inquirer.prompt(preguntaPeliculas).then(function (answers) {
...
var guardarEnArchivo = function (nombreArchivo, pelicula) {
